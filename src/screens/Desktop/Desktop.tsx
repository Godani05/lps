...
//       hasDropdown: true,
//       submenu: [
//         // { name: "Présentation", url: "/le-lycee/presentation" },
//         // { name: "Mot du Directeur", url: "/le-lycee/mot-du-directeur" },
//         // { name: "Organisation", url: "/le-lycee/organisation" },
//         // { name: "Vie Scolaire", url: "/le-lycee/vie-scolaire" },
...
export const Desktop = (): JSX.Element => {
  ...
  // Calculer la hauteur combinée de la barre supérieure et du menu de navigation
  // Top bar height (16) + Navigation height (~20) = 36rem (estimation)
  // Ajustez cette valeur selon la hauteur réelle de vos éléments
  const headerHeight = "4rem";

  return (
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white overflow-hidden w-full max-w-[1440px] relative">
        {/* Header fixe (Top Bar + Navigation) */}
        ...
        {/* Espace de remplissage pour compenser les éléments fixes */}
        ...
        <div className="w-full h-[610px] relative">
          ...
          <div
            onClick={() => (window.location.href = "")}
            className="absolute bottom-32 left-8 px-6 py-3 rounded-sm bg-[#1a3a76] flex items-center justify-center cursor-pointer hover:bg-[#e2df73] text-white hover:text-[#1a3a76] text-lg transition-colors duration-300"
          >
            <button className="font-normal ">NOUS DECOUVRIR</button>
          </div>
        </div>
